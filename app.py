...
# load files===========================================================================================================
trending_products = pd.read_csv(r"E-Commerece-Recommendation-System-Machine-Learning-Product-Recommendation-system--main/trending_products.csv")
train_data = pd.read_csv(r"C:\Users\RUSHAY\Desktop\F\E-Commerece-Recommendation-System-Machine-Learning-Product-Recommendation-system--main\clean_data.csv")
...
@app.route("/main")
def main():
    content_based_rec = pd.DataFrame()  # Example if empty or initialize with actual data
...
def recommendations():
    if request.method == 'POST':
        ...
        if nbr is None or nbr.strip() == '':
            nbr = 0  # or any default value, or return an error message
        else:
            nbr = int(nbr)
